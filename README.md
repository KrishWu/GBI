...
To plot the gravitational wave features learned and generated by the model, one can run:

```
law run SignalGenerationPlot --version test_0 --num-ensemble 10 --num-generated-sigs 1000000 --workers 3
```
